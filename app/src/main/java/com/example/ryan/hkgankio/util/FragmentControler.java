...
public class FragmentControler {
    ...
    public String showMainFragment(Fragment currentFragment) {
    ...
    public String showChildFragment(Fragment currentFragment) {
     ...
     * @param containner
     */
    private void addFragment(FragmentManager manager, String tag, int stackid, Fragment fragment, int containner) {
